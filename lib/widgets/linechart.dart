...
//     ParameterData("O₂(1)", Colors.white, Random().nextInt(10) + 1),
//     ParameterData("VAC", Colors.yellow, Random().nextInt(10) + 11),
//     ParameterData("N₂O", const Color.fromARGB(255, 0, 34, 145),
//         Random().nextInt(10) + 21),
//     ParameterData("AIR", const Color.fromARGB(255, 198, 230, 255),
//         Random().nextInt(10) + 51),
//     ParameterData(
//         "CO₂", const Color.fromRGBO(62, 66, 70, 1), Random().nextInt(10) + 61),
//     ParameterData("O₂(2)", const Color.fromARGB(255, 255, 255, 255),
//         Random().nextInt(10) + 71),
//     ParameterData("TEMP", const Color.fromARGB(255, 195, 0, 0),
//         Random().nextInt(10) + 31),
//     ParameterData("HUMI", Colors.blue, Random().nextInt(10) + 41),
//   ];
//   List parameterNames = [
//     "O2(1)",
//     "VAC",
...
//           newValue = Random().nextInt(10) + 11;
//         } else if (param.name == "N₂O") {
//           newValue = Random().nextInt(10) + 21;
//         } else if (param.name == "AIR") {
//           newValue = Random().nextInt(10) + 31;
//         } else if (param.name == "CO₂") {
//           newValue = Random().nextInt(10) + 41;
//         } else if (param.name == "O₂(2)") {
//           newValue = Random().nextInt(10) + 51;
//         } else if (param.name == "TEMP") {
//           newValue = Random().nextInt(10) + 61;
//         } else {
//           newValue = Random().nextInt(10) + 71;
//         }
//         return ParameterData(param.name, param.color, newValue);
//       }).toList();
//     });
//   }
...
//         int newValue;
//         if (param.name == "O₂(1)") {
//           newValue = Random().nextInt(11) + 1;
//         } else if (param.name == "VAC") {
//           newValue = Random().nextInt(11) + 11;
//         } else if (param.name == "N₂O") {
//           newValue = Random().nextInt(11) + 21;
//         } else if (param.name == "AIR") {
//           newValue = Random().nextInt(11) + 31;
//         } else if (param.name == "CO₂") {
//           newValue = Random().nextInt(11) + 41;
//         } else if (param.name == "O₂(2)") {
//           newValue = Random().nextInt(11) + 51;
//         } else if (param.name == "TEMP") {
//           newValue = Random().nextInt(11) + 61;
//         } else {
//           newValue = Random().nextInt(11) + 71;
//         }
//         return ParameterData(param.name, param.color, newValue);
//       }).toList();
//       chartData = chartData.map((data) {
//         data[1] = Random().nextInt(10) + 1;
//         data[2] = Random().nextInt(10) + 11;
//         data[3] = Random().nextInt(10) + 21;
//         data[4] = Random().nextInt(10) + 31;
//         data[5] = Random().nextInt(10) + 41;
//         data[6] = Random().nextInt(10) + 51;
//         data[7] = Random().nextInt(10) + 61;
//         data[8] = Random().nextInt(10) + 71;
//         return data;
//       }).toList();
//     });
//   }
...
class LineCharWid extends StatefulWidget {
  const LineCharWid({Key? key, required int maxLimit, required int minLimit}) : super(key: key);
