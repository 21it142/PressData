...
class $ErrordemoTableTable extends ErrordemoTable
    with TableInfo<$ErrordemoTableTable, ErrordemoTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ErrordemoTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'errordemo_table';
  @override
  VerificationContext validateIntegrity(Insertable<ErrordemoTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ErrordemoTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ErrordemoTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      DeviceNo: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}DeviceNo'])!,
  ...
  @override
  $ErrordemoTableTable createAlias(String alias) {
    return $ErrordemoTableTable(attachedDatabase, alias);
  }
}

class ErrordemoTableData extends DataClass
    implements Insertable<ErrordemoTableData> {
  final int id;
  final String DeviceNo;
  final String parameter;
  final String logValue;
  ...
  ErrordemoTableCompanion toCompanion(bool nullToAbsent) {
    return ErrordemoTableCompanion(
      id: Value(id),
      DeviceNo: Value(DeviceNo),
      parameter: Value(parameter),
      logValue: Value(logValue),
  ...
  factory ErrordemoTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ErrordemoTableData(
      id: serializer.fromJson<int>(json['id']),
  ...
  ErrordemoTableData copyWithCompanion(ErrordemoTableCompanion data) {
    return ErrordemoTableData(
      id: data.id.present ? data.id.value : this.id,
      DeviceNo: data.DeviceNo.present ? data.DeviceNo.value : this.DeviceNo,
      parameter: data.parameter.present ? data.parameter.value : this.parameter,
  ...
  @override
  String toString() {
    return (StringBuffer('ErrordemoTableData(')
          ..write('id: $id, ')
          ..write('DeviceNo: $DeviceNo, ')
          ..write('parameter: $parameter, ')
          ..write('logValue: $logValue, ')
...
class ErrordemoTableCompanion extends UpdateCompanion<ErrordemoTableData> {
  final Value<int> id;
  final Value<String> DeviceNo;
  final Value<String> parameter;
  final Value<String> logValue;
  ...
  ErrordemoTableCompanion.insert({
    this.id = const Value.absent(),
    required String DeviceNo,
    required String parameter,
    required String logValue,
    ...
    this.recordedAt = const Value.absent(),
        ...
        maxValue = Value(maxValue),
        value = Value(value);
  static Insertable<ErrordemoTableData> custom({
    Expression<int>? id,
    Expression<String>? DeviceNo,
    Expression<String>? parameter,
    Expression<String>? logValue,
  ...
  ErrordemoTableCompanion copyWith(
      {Value<int>? id,
      Value<String>? DeviceNo,
      Value<String>? parameter,
      Value<String>? logValue,
  ...
  @override
  String toString() {
    return (StringBuffer('ErrordemoTableCompanion(')
          ..write('id: $id, ')
          ..write('DeviceNo: $DeviceNo, ')
          ..write('parameter: $parameter, ')
          ..write('logValue: $logValue, ')
...
class $PressDataDemoTableTable extends PressDataDemoTable
    with TableInfo<$PressDataDemoTableTable, PressDataDemoTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $PressDataDemoTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'press_data_demo_table';
  @override
  VerificationContext validateIntegrity(
      Insertable<PressDataDemoTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PressDataDemoTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PressDataDemoTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      temperature: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}temperature'])!,
  ...
  @override
  $PressDataDemoTableTable createAlias(String alias) {
    return $PressDataDemoTableTable(attachedDatabase, alias);
  }
}

class PressDataDemoTableData extends DataClass
    implements Insertable<PressDataDemoTableData> {
  final int id;
  final int temperature;
  final int humidity;
  final int o2;
  ...
  PressDataDemoTableCompanion toCompanion(bool nullToAbsent) {
    return PressDataDemoTableCompanion(
      id: Value(id),
      temperature: Value(temperature),
      humidity: Value(humidity),
      o2: Value(o2),
  ...
  factory PressDataDemoTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PressDataDemoTableData(
      id: serializer.fromJson<int>(json['id']),
  ...
  PressDataDemoTableData copyWith(
          {int? id,
          int? temperature,
          int? humidity,
          int? o2,
  ...
  PressDataDemoTableData copyWithCompanion(PressDataDemoTableCompanion data) {
    return PressDataDemoTableData(
      id: data.id.present ? data.id.value : this.id,
      temperature:
          data.temperature.present ? data.temperature.value : this.temperature,
  ...
  @override
  String toString() {
    return (StringBuffer('PressDataDemoTableData(')
          ..write('id: $id, ')
          ..write('temperature: $temperature, ')
          ..write('humidity: $humidity, ')
          ..write('o2: $o2, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PressDataDemoTableData &&
          other.id == this.id &&
          other.temperature == this.temperature &&
          other.humidity == this.humidity &&
          other.o2 == this.o2 &&
...
class PressDataDemoTableCompanion
    extends UpdateCompanion<PressDataDemoTableData> {
  final Value<int> id;
  final Value<int> temperature;
  final Value<int> humidity;
  final Value<int> o2;
  ...
  final Value<String> vac_error;
  final Value<DateTime?> recordedAt;
  const PressDataDemoTableCompanion({
    this.id = const Value.absent(),
    this.temperature = const Value.absent(),
    this.humidity = const Value.absent(),
    this.o2 = const Value.absent(),
  ...
  PressDataDemoTableCompanion.insert({
    this.id = const Value.absent(),
    required int temperature,
    required int humidity,
    required int o2,
    ...
    this.recordedAt = const Value.absent(),
        ...
        o2_2_error = Value(o2_2_error),
        vac_error = Value(vac_error);
  static Insertable<PressDataDemoTableData> custom({
    Expression<int>? id,
    Expression<int>? temperature,
    Expression<int>? humidity,
    Expression<int>? o2,
  ...
  PressDataDemoTableCompanion copyWith(
      {Value<int>? id,
      Value<int>? temperature,
      Value<int>? humidity,
      Value<int>? o2,
  ...
  @override
  String toString() {
    return (StringBuffer('PressDataDemoTableCompanion(')
          ..write('id: $id, ')
          ..write('temperature: $temperature, ')
          ..write('humidity: $humidity, ')
          ..write('o2: $o2, ')
...
abstract class _$PressDataDb extends GeneratedDatabase {
  ...
  late final $ErrordemoTableTable errordemoTable = $ErrordemoTableTable(this);
  late final $PressDataDemoTableTable pressDataDemoTable =
      $PressDataDemoTableTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [pressDataTable, errorTable, errordemoTable, pressDataDemoTable];
}
...
typedef $$ErrordemoTableTableCreateCompanionBuilder = ErrordemoTableCompanion
    Function({
  Value<int> id,
  required String DeviceNo,
  required String parameter,
...
typedef $$ErrordemoTableTableUpdateCompanionBuilder = ErrordemoTableCompanion
    Function({
  Value<int> id,
  Value<String> DeviceNo,
  Value<String> parameter,
...
class $$ErrordemoTableTableTableManager extends RootTableManager<
    _$PressDataDb,
    $ErrordemoTableTable,
    ErrordemoTableData,
    $$ErrordemoTableTableFilterComposer,
    $$ErrordemoTableTableOrderingComposer,
    $$ErrordemoTableTableCreateCompanionBuilder,
    $$ErrordemoTableTableUpdateCompanionBuilder> {
  $$ErrordemoTableTableTableManager(
      _$PressDataDb db, $ErrordemoTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
              $$ErrordemoTableTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$ErrordemoTableTableOrderingComposer(ComposerState(db, table)),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String> DeviceNo = const Value.absent(),
            Value<String> parameter = const Value.absent(),
...
class $$ErrordemoTableTableFilterComposer
    extends FilterComposer<_$PressDataDb, $ErrordemoTableTable> {
  $$ErrordemoTableTableFilterComposer(super.$state);
  ColumnFilters<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$ErrordemoTableTableOrderingComposer
    extends OrderingComposer<_$PressDataDb, $ErrordemoTableTable> {
  $$ErrordemoTableTableOrderingComposer(super.$state);
  ColumnOrderings<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
typedef $$PressDataDemoTableTableCreateCompanionBuilder
    = PressDataDemoTableCompanion Function({
  Value<int> id,
  required int temperature,
  required int humidity,
  required int o2,
...
typedef $$PressDataDemoTableTableUpdateCompanionBuilder
    = PressDataDemoTableCompanion Function({
  Value<int> id,
  Value<int> temperature,
  Value<int> humidity,
...
class $$PressDataDemoTableTableTableManager extends RootTableManager<
    _$PressDataDb,
    $PressDataDemoTableTable,
    PressDataDemoTableData,
    $$PressDataDemoTableTableFilterComposer,
    $$PressDataDemoTableTableOrderingComposer,
    $$PressDataDemoTableTableCreateCompanionBuilder,
    $$PressDataDemoTableTableUpdateCompanionBuilder> {
  $$PressDataDemoTableTableTableManager(
      _$PressDataDb db, $PressDataDemoTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
              $$PressDataDemoTableTableFilterComposer(ComposerState(db, table)),
          orderingComposer: $$PressDataDemoTableTableOrderingComposer(
...
class $$PressDataDemoTableTableFilterComposer
    extends FilterComposer<_$PressDataDb, $PressDataDemoTableTable> {
  $$PressDataDemoTableTableFilterComposer(super.$state);
  ColumnFilters<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$PressDataDemoTableTableOrderingComposer
    extends OrderingComposer<_$PressDataDb, $PressDataDemoTableTable> {
  $$PressDataDemoTableTableOrderingComposer(super.$state);
  ColumnOrderings<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class $PressDataDbManager {
  ...
  $$ErrordemoTableTableTableManager get errordemoTable =>
      $$ErrordemoTableTableTableManager(_db, _db.errordemoTable);
  $$PressDataDemoTableTableTableManager get pressDataDemoTable =>
      $$PressDataDemoTableTableTableManager(_db, _db.pressDataDemoTable);
}
